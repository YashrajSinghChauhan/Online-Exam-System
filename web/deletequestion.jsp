<%-- 
    ...
    Created on : 28 Apr, 2021, 12:39:42 PM
    Author     : HP
--%>
...
<html>
    <head>
        ...
        <title>Pariksha |Delete Page</title>
    </head>
    <body>
        <%
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <form class="form-horizontal" action="deletequestion.jsp" method="POST">
                                <div class="card-body">
...
if(b1!=null)
{ System.out.println("BUTTON B1"+b1);
    String sub=request.getParameter("sub");
    String s1=request.getParameter("QNO");
      System.out.println("Subject B1"+sub);
       System.out.println("Ques no B1"+s1);
    try{
    Class.forName("com.mysql.cj.jdbc.Driver");
    String url="jdbc:mysql://localhost:3306/Subject?useSSL=false";
    String name="root";	
