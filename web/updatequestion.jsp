<%-- 
    ...
    Created on : 28 Apr, 2021, 12:39:57 PM
    Author     : HP
--%>
...
<html>
    <head>
        ...
        <title>Pariksha| Update Page</title>
    </head>
    <body>
        <%
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <form class="form-horizontal" action="updatequestion.jsp" method="POST">
                                <div class="card-body">
...
%>          
           ...
           <div class="form-group row">
            ...
            <div class="form-group row">
                    <div class="col-4">
                        <input   type="submit" name="Update" class="btn btn-primary" id="lname" value="Update">
                    </div>
            </div>
<%
    }
...
<%
       String b1=request.getParameter("Update");
       if(b1!=null)
       {
        String sub1=request.getParameter("sub");
 ...
 try{
     ...
     Statement st=con.createStatement();
     String q="update "+sub1+" set Q='"+s1+"',QUES='"+s2+"',OP1='"+s3+"',OP2='"+s4+"',OP3='"+s5+"',OP4='"+s6+"',CORRECT='"+s7+"'  where Q='"+s1+"'";
     st.executeUpdate(q);
